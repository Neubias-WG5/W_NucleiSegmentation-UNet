...
def get_core(dim1, dim2, channels=1):
    
    x = keras.layers.Input(shape=(dim1, dim2, channels))
...
def get_model_3_class(dim1, dim2, activation="softmax", channels=1):
    
    [x, y] = get_core(dim1, dim2, channels)
